...
public class SQLiteListAdapterRealisasi extends BaseAdapter {
    ...
    public SQLiteListAdapterRealisasi(
            Context context2,
            ArrayList<String> id,
            ArrayList<String> komoditas,
            ArrayList<String> bulan,
    ...
    public View getView(int position, View child, ViewGroup parent) {
        ...
        if (child == null) {
            ...
            child = layoutInflater.inflate(R.layout.listviewdatalayoutrealisasi, null);

            holder = new Holder();

            holder.textviewkomoditas = (TextView) child.findViewById(R.id.textViewKOMODITAS);
            holder.textviewtbulan = (TextView) child.findViewById(R.id.textViewBULAN);
        ...
        holder.textviewtbulan.setText(Bulan.get(position));
